...
const Handles = () => {
  return (
    ...
    <a  href="https://www.linkedin.com/in/pranabanti-karmaakar-273a8928a/" target="_blank"><AiFillLinkedin className=" text-gray-300  hover:text-gray-700" style={{ height: "30px",width:"30px" }}/></a>
